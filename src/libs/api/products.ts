...
export class ProductsApi {
     ...
     */
    static async create(name: string, description: string, price: number, quantity: string, image: File) {
        try {
            const response = await api.post(ProductsApi.apiPath, {
                name,
                description,
                price,
                quantity,
     ...
     */
    static async getAll(query: { search?: string, order: 'name' | 'price', direction: 'asc' | 'desc' } = {
        search: '', order: 'name', direction: 'asc'
    }) {
        try {
     ...
     */
    static async update(id: number, data: { name?: string, description?: string, price?: number, quantity?: string, image?: File }) {
        try {
