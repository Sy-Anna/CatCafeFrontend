	...
	return (
		<Navbar expand='lg' fixed='top' className='navbar'>
			<Navbar.Brand className='navBrand align-self-center' href='/Home'>
				<img src={logoSmall} width='40' height='40' className='d-inline-block align-top logo' alt='Cat Cafe logo' />
			</Navbar.Brand>
			...
			<div className='d-flex gap-3 align-items-center'>
				<Form.Check className='navSwitch' type='switch' checked={dark} onChange={toggleDarkMode} />
