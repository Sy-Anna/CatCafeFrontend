...
function Cargo () {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const [error, response] = await ProductsApi.create(name, description, parseFloat(price), quantity, image);
  ...
  return (
    <Container fluid="lg" className="mt-4 card-grid">
      ...
      <Form onSubmit={handleSubmit} className="mt-5">
        ...
        <Button className='loginBtn' type='submit' disabled={formLoading}>
