...
const addresses = [
	...
	},
	{
		...
		description: "Itt tároljuk termékeinket, míg otthonaitokba vagy kávéházunkba meg nem érkezik.",
	},
];
						...
						<Card className='aboutCard'>
							...
							<div className='content'>
								<div className='contentTop'>
									...
									<p className='aboutCardAddress'>{address.address}</p>
									<img className='aboutIcon' src={phoneIcon} alt='icon' />
									<p className='aboutCardPhone'>{address.phone}</p>
								</div>
								<p className='aboutCardDescription'>{address.description}</p>
							</div>
						</Card>
					</Col>
				))}
